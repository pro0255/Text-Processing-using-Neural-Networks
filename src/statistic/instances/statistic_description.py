...
class StatisticDescription:
    def __init__(
        ...
        self.state[
            StatisticDescriptionField.NumberOfSentences.value
        ] = number_of_sentences
        self.state[StatisticDescriptionField.SubsetType.value] = subset_type
        self.state[StatisticDescriptionField.Path.value] = path
        self.state[
            StatisticDescriptionField.PreprocessingType.value
        ] = preprocessing_type
        self.state[
            StatisticDescriptionField.TransformerTokenizer.value
